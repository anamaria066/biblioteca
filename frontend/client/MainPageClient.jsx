...
function MainPageClient() {
  ...
  const cartiAfisate = filteredBooks.slice(
    indexStart,
    indexStart + cartiPerPagina
  );
    ...
    <div className="main-container-client">
      ...
      {showFilterPopup && (
        <div className="popup-filtru-client" ref={popupRef}>
          ...
          <label>Limba:</label>
          <select
            value={limbaSelectata}
            onChange={(e) => setLimbaSelectata(e.target.value)}
          >
          ...
          <select
            ...
            onChange={(e) => setIntervalSelectat(e.target.value)}
          >
